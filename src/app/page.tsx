...
export default function PhoneRentalHome() {
  ...
  const handleBack = () => {
    setPageError("");
    // 4 → 3: ย้อนไปแก้ข้อมูลตัวเอง (ชื่อ/เบอร์/เลนส์) แต่ยังเอาเครื่องรุ่นเดิมอยู่ → "คง" การกันเครื่องไว้
    //        ไม่งั้นแค่ย้อนไปแก้เบอร์แป๊บเดียวก็เสียสิทธิ์ให้คนอื่นแย่งไป ซึ่งขัดกับเจตนาของการกันเครื่อง
    //        (ถ้าอยู่หน้านี้นานจนเกิน 7 นาที ของก็หมดอายุคืนเข้าระบบเองอยู่ดี)
    // 3 → 2: กำลังจะไปเปลี่ยนรุ่น/รอบ = ไม่เอารุ่นนี้แล้ว → คืนเครื่องให้คนอื่นทันที
    if (step === 3) releaseHold();
