...
const faqs: Faq[] = [
  ...
  },
  {
    ...
    ordered: true,
    items: [
      "สำเนาบัตรประชาชน สามารถใช้เป็นไฟล์ได้ โดยเขียนกำกับว่า “ใช้สำหรับเช่าโทรศัพท์ร้าน CRABBY เท่านั้น”",
      "ถ่ายรูปเป็นหลักฐานในขณะรับเครื่อง",
    ],
  },
  { q: "ชำระเงินช่องทางไหนได้บ้าง?", a: "รับชำระ เงินสด / QR Code" },
  { q: "จองแล้วสามารถเปลี่ยนรุ่น/เปลี่ยนวันได้ไหม?", a: "สามารถสอบถามคิวว่างกับแอดมินก่อนได้ค่ะ ทั้งนี้ขึ้นอยู่กับคิวว่างของรุ่นและวันที่ต้องการเปลี่ยนค่ะ" },
  {
  ...
  {
    q: "ต้องคืนเครื่องเมื่อไหร่?",
    a: "กรุณาคืนเครื่อง ภายใน 40 นาทีหลังคอนเสิร์ตจบ สำหรับงานที่มี Benefit หลังจบคอนเสิร์ต และกิจกรรมอาจสิ้นสุดดึก ทางร้านขอให้คืนเครื่อง หลังจบช่วงคอนเสิร์ต ก่อนเริ่ม Benefit ค่ะ",
  },
